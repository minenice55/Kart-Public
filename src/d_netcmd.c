...
//new skin select
//taken from callmore's skin select grid with permission
static CV_PossibleValue_t skinselectmenu_t[] = {
	{SKINMENUTYPE_SCROLL, "Scroll"}, 
	{SKINMENUTYPE_GRID, "Grid"}, 
	{0, NULL}
};
